...
<body>
		...
		<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
			...
			<ul
				...
				<li class="am-dropdown" data-am-dropdown><a
					...
					href="javascript:;"> <span class="am-icon-users"></span> <%=session.getAttribute("AdminName")%>，欢迎您
		...
		<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
			<div class="am-offcanvas-bar admin-offcanvas-bar">
				<ul class="am-list admin-sidebar-list">
					<li><a href="news.jsp" title="新闻管理"><span
							class="am-icon-pencil-square-o"></span> 新闻管理</a></li>

					<li><a href="adminUser.jsp" title="管理员管理"><span
							class="am-icon-bookmark"></span> 管理员管理</a></li>
				</ul>
	...
	<div class="am-popup" id="edit-popup">
		<div class="am-popup-inner">
			...
			<div class="am-popup-bd">
				<form action="newsEdit.jsp" method="post" class="am-form"
					id="edit-msg">
					<fieldset>
						<div class="am-form-group">
							<label for="doc-vld-ta-2-1"> 新闻标题： </label> <input
						...
						<input name="Action" type="hidden" value="Edit"> <input
							id="newsId" name="newsId" type="hidden" value="">
	...
	<footer>
		<hr>
		<p class="am-padding-left">© 2016 明日科技</p>
	</footer>
